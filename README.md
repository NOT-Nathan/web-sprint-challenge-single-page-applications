...
I believe it allows one to assign a varible with the same path a route would but without explicitly requiring a route. Quite unsure about that though.
1. How would you explain form validation to someone who has never programmed before?
Form validation, it's a set of rules we programmers write to help users of our website input proper form data. So when you try and register to a website you use it may ask for your email, and it won't let you register until you provide a proper email. That is form validation in action!
1. In 1-2 sentences, define end to end testing.
End to end testing is a group of tests aimed at 'testing the functionality of your entire website.'
## Instructions
